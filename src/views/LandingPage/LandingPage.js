				...
				<div className={classes.container}>
					<GridContainer>
						<GridItem xs={12} sm={12} md={6}>
							<h1 className={classes.title}>Create a Portfolio in 4 easy steps. </h1>{' '}
                      ...
                      <LanguageRoundedIcon fontSize="large" />
							...
							<h4>
								Create a digital Portfolio in few minutes, by filling our intuitive form.Portfolio
								Generator will host your Portfolio on the fastest web servers and will provide you an
								easy - to - share {' '}
								<a
									href="https://bp-gc.in/"
									style={{
							...
							<Link to="section1" smooth={true} offset={-70} duration={500}>
								<Button round color="success" size="lg" rel="noopener noreferrer">
										...
										<div className="Tilt-inner">
											...
											>
												<CardContent>
													...
													>
														By continuing, I agree that I am at least 13 years old and have
														read and agree to Terms of Service and Privacy Policy.{' '}
													</Typography>{' '}
												</CardContent>{' '}
											</Card>{' '}
										</div>{' '}

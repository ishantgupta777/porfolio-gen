...
function getSteps() {
	return [ 'Choose a Template', 'Basic Information', 'Add Skills and Testimonials', 'Add Experience and Projects' ];
}
...
export default function ProductSection() {
	...
	const [ skills, setSkills ] = React.useState([ { id: 1, skill_name: '', skill_level: 'Beginner' } ]);
	const [ tests, setTests ] = React.useState([
		{ id: 1, testimonial_name: '', testimonial_cred: '', testimonial_desc: '' }
	]);
	const [ langs, setLangs ] = React.useState([ { id: 1, name: '', level: 'Native Speaker' } ]);
	...
	const handlePubs = (field, id, evn) => {
		...
		if (field === 'publish_date') {
			setPubs([ ...pubs.slice(0, id), { ...pubs[id], publish_date: evn }, ...pubs.slice(id + 1, pubs.length) ]);
		}
	...
	const handlePros = (field, id, evn) => {
		...
		if (field === 'proj_image') {
			...
			uploadTask.on(
				...
				() => {
					// complete function ...
					storage.ref('images').child(imageFb.name).getDownloadURL().then((url) => {
						setPros([
							...pros.slice(0, id),
											...
											<ButtonGroup>
												<AnchorLink href="#top">
													<Button
														...
														onClick={handleBack}
														color="primary"
														className={classNames(classes.button, classes.buttonWide)}
													>
														Back
													</Button>
												</AnchorLink>
									...
									<div>
										<ThemeProvider theme={theme} className={classes.contentCard}>
											...
											{skills.map((el) => (
												...
												<GridContainer id={el.id} className={classes.contentCard} key={el.id}>
													<GridItem xs={12} sm={12} md={12}>
										...
										<ThemeProvider theme={theme}>
											<h2 style={{ color: 'black', marginTop: '60px' }}>Testimonials</h2>
											{tests.map((el) => (
												// eslint-disable-next-line react/jsx-key
												<GridContainer id={el.id} className={classes.contentCard}>
													<GridItem xs={12} sm={12} md={12}>
														<h2 className={classes.delete}>
															<Button color="secondary" onClick={() => deleteTest(el.id)}>
										...
										<ThemeProvider theme={theme}>
											<h2 style={{ color: 'black', marginTop: '60px' }}>Languages</h2>
											{langs.map((el) => (
												// eslint-disable-next-line react/jsx-key
												<GridContainer id={el.id} className={classes.contentCard}>
													<GridItem xs={12} sm={12} md={12}>
														<h2 className={classes.delete}>
															<Button color="secondary" onClick={() => deleteLang(el.id)}>
																<img src={cancel} alt="cancel" style={{ width: '30px' }} />{' '}
															</Button>
														</h2>
													</GridItem>
							...
							{activeStep === 3 ? (
								<div>
									<div>
										<ThemeProvider theme={theme}>
											...
											{pubs.map((el) => (
												...
												<GridContainer id={el.id} className={classes.contentCard}>
													<GridItem xs={12} sm={12} md={12}>
														<h2 className={classes.delete}>
															<Button color="secondary" onClick={() => deletePub(el.id)}>
																<img src={cancel} alt="cancel" style={{ width: '30px' }} />{' '}
															</Button>
														</h2>
													</GridItem>
										...
										<ThemeProvider theme={theme}>
											<h2 style={{ color: 'black', marginTop: '40px' }}>Experience</h2>
											{exps.map((el) => (
												// eslint-disable-next-line react/jsx-key
												<GridContainer id={el.id} className={classes.contentCard}>
													<GridItem xs={12} sm={12} md={12}>
														<h2 className={classes.delete}>
															<Button color="secondary" onClick={() => deleteExp(el.id)}>
																<img src={cancel} alt="cancel" style={{ width: '30px' }} />{' '}
															</Button>
														</h2>
													</GridItem>
										...
										<ThemeProvider theme={theme}>
											<h2 style={{ color: 'black', marginTop: '40px' }}>Education</h2>
											{edus.map((el) => (
												// eslint-disable-next-line react/jsx-key
												<GridContainer id={el.id} className={classes.contentCard}>
													{el.id !== 1 ? (
										...
										<ThemeProvider theme={theme}>
											<h2 style={{ color: 'black', marginTop: '40px' }}>Achievements</h2>
											{achs.map((el) => (
												// eslint-disable-next-line react/jsx-key
												<GridContainer id={el.id} className={classes.contentCard}>
													<GridItem xs={12} sm={12} md={12}>
														<h2 className={classes.delete}>
															<Button color="secondary" onClick={() => deleteAch(el.id)}>
																<img src={cancel} alt="cancel" style={{ width: '30px' }} />{' '}
															</Button>
														</h2>
													</GridItem>
										...
										<ThemeProvider theme={theme}>
											<h2 style={{ color: 'black', marginTop: '40px' }}>Projects</h2>
											{pros.map((el) => (
												// eslint-disable-next-line react/jsx-key
												<GridContainer id={el.id} className={classes.contentCard} key={el.id}>
													<GridItem xs={12} sm={12} md={12}>
														<h2 className={classes.delete}>
															<Button color="secondary" onClick={() => deleteProj(el.id)}>
																<img src={cancel} alt="cancel" style={{ width: '30px' }} />{' '}
															</Button>
														</h2>
													</GridItem>
				...
				>
					...
					<DialogActions>
						{!response ? (
							...
							<div>
								<Tooltip title={!copied ? 'Copy to clipboard' : 'Copied'} aria-label="add">
